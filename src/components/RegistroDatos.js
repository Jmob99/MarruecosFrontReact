            ...
            <section>
              ...
              <div className={`contenedorDesplegable ${ingresarDatosVisible ? 'visible' : ''}`} id="contenedorIngresarDatos">
                <form id="ingreso-reserva" className="formulario">
                  <label className="texto-formulario" htmlFor='fechaIngreso'>* Fecha de ingreso</label>
                  <input
                    type="date"
                    id="fechaIngreso"
                    name="fecha-ingreso"
                  ...
                  />
                  <label className="texto-formulario" htmlFor='fechaSalida'>* Fecha de salida</label>
                  <input
                    type="date"
                    id="fechaSalida"
                    name="fecha-salida"
                  ...
                  />
                  <label className="texto-formulario" htmlFor='cantidadDias'>Cantidad de días</label>
                  <input
                    type="number"
                    id="cantidadDias"
                    name="cantidad-dias"
